...
export class DefenseCenter {
  ...
  private static manageRamparts(room: Room) {
      ...
      const criticalStructures = [
          ...
          ...room.find(FIND_MY_STRUCTURES, { filter: s => s.structureType === STRUCTURE_NUKER }),
          ...room.find(FIND_MY_STRUCTURES, { filter: s => s.structureType === STRUCTURE_OBSERVER }),
          ...room.find(FIND_MY_STRUCTURES, { filter: s => s.structureType === STRUCTURE_POWER_SPAWN }),
          ...room.find(FIND_MY_STRUCTURES, { filter: s => s.structureType === STRUCTURE_FACTORY }),
